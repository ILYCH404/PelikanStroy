...
public class UserUtil {
    ...
    public static User createNewFromTo(UserTo userTo) {
        return new User(null, userTo.getFirstName(), userTo.getMiddleName(), userTo.getLastName(), userTo.getPhone(), userTo.getEmail().toLowerCase(), userTo.getPassword(), Role.USER);
    }
